...
export interface ApiActivityLogActivityLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activity_level: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    keyboard_clicks: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mouse_clicks: Schema.Attribute.Integer;
...
export interface ApiActivityReportActivityReport
  extends Struct.CollectionTypeSchema {
  collectionName: 'activity_reports';
  info: {
    displayName: 'ActivityReport';
    pluralName: 'activity-reports';
    singularName: 'activity-report';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::activity-report.activity-report'
    > &
      Schema.Attribute.Private;
    productivity_score: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    report_date: Schema.Attribute.Date;
    screenshots_count: Schema.Attribute.Integer;
    total_keyboards_clicks: Schema.Attribute.Integer;
    total_mouse_clicks: Schema.Attribute.Integer;
    total_work_time: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiAttendanceAttendance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    check_in_late_minutes: Schema.Attribute.Integer &
    ...
    early_checkout_minutes: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    ...
    users_permissions_user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    work_hours: Schema.Attribute.Decimal;
  };
}
...
export interface ApiBreakBreak extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    statuts: Schema.Attribute.Enumeration<['ACTIVE', 'ENDED']> &
      Schema.Attribute.DefaultTo<'ACTIVE'>;
    time_log: Schema.Attribute.Relation<'manyToOne', 'api::time-log.time-log'>;
    type: Schema.Attribute.Enumeration<['LUNCH', 'COFFEE', 'SHORT', 'OTHER']> &
...
export interface ApiHolidayHoliday extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    applicable_to: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['PUBLIC', 'COMPANY', 'RELIGIOUS']> &
...
export interface ApiLeaveRequestLeaveRequest
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    manager_comments: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ...
    type: Schema.Attribute.Enumeration<
      ['ANNUAL', 'SICK', 'PERSONAL', 'UNPAID', 'MATERNITY', 'OTHER']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['INFO', 'WARNING', 'ALERT', 'SYSTEM']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiOvertimeRequestOvertimeRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'overtime_requests';
  info: {
    description: '';
    displayName: 'Overtime Request';
    pluralName: 'overtime-requests';
    singularName: 'overtime-request';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::overtime-request.overtime-request'
    > &
      Schema.Attribute.Private;
    ...
    statuts: Schema.Attribute.Enumeration<['PENDING', 'APPROVED', 'REJECTED']> &
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    overtime_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::overtime-request.overtime-request'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    time_logs: Schema.Attribute.Relation<'oneToMany', 'api::time-log.time-log'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiRoleUserRoleUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.Enumeration<['ADMIN', 'MANAGER', 'EMPLOYEE']>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    project: Schema.Attribute.Relation<'manyToOne', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
    statuts: Schema.Attribute.Enumeration<['TODO', 'IN_PROGRESS', 'DONE']>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTimeLogTimeLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    net_work_minutes: Schema.Attribute.Integer;
    project: Schema.Attribute.Relation<'manyToOne', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
    start_time: Schema.Attribute.DateTime;
    statuts: Schema.Attribute.Enumeration<['ACTIVE', 'PAUSED', 'FINISHED']>;
    total_break_minutes: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    activity_logs: Schema.Attribute.Relation<
      ...
      'api::activity-log.activity-log'
    >;
    activity_reports: Schema.Attribute.Relation<
      'oneToMany',
      'api::activity-report.activity-report'
    >;
    approved_leave_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::leave-request.leave-request'
    >;
    approved_overtime_requests: Schema.Attribute.Relation<
      'oneToMany',
      'api::overtime-request.overtime-request'
    >;
    ...
    > &
      Schema.Attribute.Private;
    my_projects: Schema.Attribute.Relation<'oneToMany', 'api::project.project'>;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    role_user: Schema.Attribute.Relation<
      'manyToOne',
      'api::role-user.role-user'
    >;
    screenshots: Schema.Attribute.Relation<
      ...
      'api::screenshot.screenshot'
    >;
    statuts: Schema.Attribute.Enumeration<['ACTIVE', 'INACTIVE', 'SUSPENDED']>;
    tasks: Schema.Attribute.Relation<'oneToMany', 'api::task.task'>;
    time_logs: Schema.Attribute.Relation<'oneToMany', 'api::time-log.time-log'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    validations: Schema.Attribute.Relation<
      'oneToMany',
      'api::overtime-request.overtime-request'
    >;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::activity-report.activity-report': ApiActivityReportActivityReport;
      ...
      'api::overtime-request.overtime-request': ApiOvertimeRequestOvertimeRequest;
